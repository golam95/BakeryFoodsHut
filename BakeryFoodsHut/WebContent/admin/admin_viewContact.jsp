...
<div class="content">
	<div class="header">
		<div style="margin-bottom: 4px;" class="titleright">
			<h1 style="text-align: center;" class="page-title">***View
			...
			<div style="margin-top: 38px;" class="manageoption">
				<a
					...
					style="padding: 5px; background: #4E2614; border: 4px solid #DAB776; border-radius: 5px; margin-left: 8px; color: #FFFFFF; font-weight: bold;"
			...
			<div class="form-group">
				<div class="addsearch_left">
					<a class="form-control" href="addEmp.html"><span
						class="glyphicon glyphicon-plus-sign"></span> Add Employee</a>
				</div>
					...
					<table style="margin-left: 40px;"
						...
						<thead>
							<tr class="active">
								...
								<th
									style="text-align: center; background-color: #583535; color: white;">Name</th>
								<th
									style="text-align: center; background-color: #583535; color: white;">Name</th>
								<th
									style="text-align: center; background-color: #583535; color: white;">Email</th>
						...
						<tbody>
							...
							<tr class="primary">
								...
								<td
									style="color: black; text-align: center; font-weight: bold; font-size: 12px;">sager</td>
								<td
									style="color: black; text-align: center; font-weight: bold; font-size: 12px;">sager</td>
								<td
									style="color: black; text-align: center; font-weight: bold; font-size: 12px;">sager</td>
								<td
									style="color: black; text-align: center; font-weight: bold; font-size: 12px;">sager</td>
								<td
									style="color: black; text-align: center; font-weight: bold; font-size: 12px;">Kay</td>
								<td
									style="color: black; text-align: center; font-weight: bold; font-size: 12px;">markay@gmai.com</td>
								<td
