			...
			<div class="col-xs-11 col-md-11 col-md-offset-1">
				...
				<form action="ManageCustomer" method="POST"
					...
					<div class="col-md-12">
						...
						<input type="hidden" name="action" value="USER_BAKERYMADE" />
						...
						<div class="form-group">
							...
							<input class="form-control" placeholder="Enter your password"
								...
								style="font-size: 13px;">*Password must be 8 character
								long</span>
						</div>
						<h3 style="margin-bottom: 35px; margin-top: 35px;">
						...
						<div class="form-group">
							<label style="font-weight: bold;" for="inputUserName">Approved
								documents by (BSTI) </label> <input class="form-control" type="file"
								name="fileName" required />
						</div>
					</div>
					<div class="form-group">
						<p>
							<input type="checkbox" required /> Before creating an account,
							please read our terms and conditions carefully <a
