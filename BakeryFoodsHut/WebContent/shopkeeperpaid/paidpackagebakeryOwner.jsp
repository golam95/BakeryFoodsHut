...
<%@page import="com.bakeryfoodshut.serviceImpl.BakeryOwnersServiceImpl"%>
<%@page import="com.bakeryfoodshut.model.BakeryOwners"%>

<%
	BakeryOwnersServiceImpl bakeryservice = new BakeryOwnersServiceImpl();
%>
		...
		<div class="container">
			<div class="row col-md-offset-2">
				...
				<form action="../ManageShopkeeperPaid" method="POST">
					<input type="hidden" name="action" value="SENDEMAILBAKERYOWNER" />
					<input type="hidden" name="sessionname" value="<%=username%>" />

					<div class="col-md-8 col-md-offset-3">
						<%
							for (BakeryOwners c : bakeryservice.getBakeryownerListInfo(username)) {
						%>
						<div class="form-group">
							<div class="col-sm-10">
								<label for="inputUserName" class="control-label">Others
									Bakery Owners</label> <select
									style="border: 1px solid #39302B; height: 35px; margin-bottom: 18px;"
									class="form-control" name="email" required>
									<option><%=c.getOwneremail()%></option>
						...
						<div class="form-group">
							<div class="col-sm-10">
								<label for="inputUserName" class="control-label">
									Comment</label>
								<textarea
									style="border: 1px solid #39302B; margin-bottom: 18px; height: 200px;"
