		...
		<div class="container">
			<div class="row col-md-offset-2">
				...
				<form action="../ManageShopkeeperPaid" method="POST">
					<input type="hidden" name="action" value="ADDOWNER" /> <input
						type="hidden" name="sessionname" value="<%=username%>" />
					<div class="col-md-8 col-md-offset-3">
						<div class="form-group">
							<div class="col-sm-10">
								<label for="inputUserName" class="control-label"> Owners
									Name</label> <input
									style="border: 1px solid #39302B; height: 35px; margin-bottom: 18px;"
									class="form-control" type="text" name="ownername" required />
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-10">
								<label for="inputUserName" class="control-label"> Email
									Address</label> <input
									style="border: 1px solid #39302B; height: 35px; margin-bottom: 18px;"
									class="form-control" type="email" name="emailaddress" required />
							</div>
						</div>
					</div>
