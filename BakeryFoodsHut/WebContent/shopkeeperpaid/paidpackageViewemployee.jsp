					...
					<div class="button_alignment">
						...
						<div style="margin-bottom: 20px;" class="">
							<a
								...
								href="../ManageShopkeeperpaidpage?action=PAID_ADDEMPLOYEE"><i
								class="icon-plus"></i> Add Employee</a> <a
								style="padding: 9px; background:#449D44; color: #FFFFFF; border-radius: 5px; font-weight: bold;"
								href="../ManageShopkeeperpaidpage?action=PRINTEMPLOYEEINFO"><i class="icon-print"></i> Print</a>
						</div>
						<%
							}
						%>
