		...
		<div class="container">
			<div class="row col-md-offset-2">
				...
				<form action="../ManageShopkeeperPaid" method="POST">
					<input type="hidden" name="action" value="PAID_DAILYREPORT" /> <input
						type="hidden" name="sessionname" value="<%=username%>" />
					<div class="col-md-8 col-md-offset-3">
						<div class="form-group">
							<div class="col-sm-12">
								 <input
									style="border: 1px solid #39302B; height: 35px; margin-bottom: 18px;width:400px;"
									 type="text" name="selectdate"
									id="dateRangepicker" required /><i
							style="font-size: 35px;" class="icon-calendar"></i>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							<div class="col-md-11">
								<button
									...
									type="submit" class="btn">Daily Report</button>
							</div>
						</div>
					</div>
				</form>
