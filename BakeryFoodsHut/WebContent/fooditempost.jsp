			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="col-md-9 col-sm-9">
					<%
						...
						List<Post> list = retrivepost.getpostList((page_one - 1) * recordsPerPage, recordsPerPage);
						int numberof_records = retrivepost.get_totalrecords();
					...
					<ul class="pagination">
						...
						<a
							...
							href="fooditempost.jsp?page=<%=page_one - 1%>"><span
						...
						%>
						<a
							style="padding: 6px; margin-left: 5px; background: #331A00; color: #FFFFFF; font-weight: bold; border-radius: 5px;"
							href="fooditempost.jsp?page=<%=j%>"><%=j%></a>
						<%
							}
						%>
						<a
							style="text-decoration: none; padding: 3px; background: white; color: black; border-radius: 5px; border: 1px solid #ddd;"
							href="fooditempost.jsp?page=<%=numberof_page%>"><span
