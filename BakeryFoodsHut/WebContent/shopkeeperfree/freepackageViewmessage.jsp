				...
				<table class="table">
					...
					<tr class="cross">
						...
						<td class="t-data t-w3l"><a
							...
							class="add-1"
							href="../ManageShopkeeperFree?deleteMessage=<%=s.getMessageId()%>"
							...
							class="add-1"
							href="../ManageShopkeeperFree?changemessagerole=<%=s.getMessageId()%>"><i
								class="icon-eye-open"></i> </a> <a
							style="text-decoration: none; color: green; font-size: 22px; font-weight: bold;"
							class="add-1"
							href="freepackageSendmessage.jsp?sendmessage=<%=s.getMessageId()%>"><i
